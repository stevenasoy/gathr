            ...
            <>
              ...
              <div className="review-card">
                <div className="review-photo">
                  {photos[0]
                    ? <img src={photos[0]} alt={form.name} loading="lazy" decoding="async" onError={(e) => { e.currentTarget.style.display = 'none' }} />
                ...
                <div className="review-info">
                  ...
                  <span className="review-price">{peso(Number(form.pricePerHour))} <em>/ {unitWord(form.priceUnit)}</em></span>
